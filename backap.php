...
$sql="SELECT `id`, `name`, `address`, `city`, `max-capacity`, `category`, `user-name`,`real-time`,`opening`,`closing` FROM `shops` WHERE `user-name`='$get_user'";
...
while($row = mysqli_fetch_array($result)) {
  ...
  echo "<td>" . $int_cast , "% -Arrival is not recommended <i style='font-size: 24px; color: red;' class='fas fa-ban'></i>" . "</td>";
   ...
   echo "<td>open:".$row['opening']."<br>close:".$row['closing']."</td>";
  echo "</tr>";
  }
}
else {
while($row = mysqli_fetch_array($result)) {
  ...
  echo "<td>" . $int_cast , "% -Arrival is not recommended <i style='font-size: 24px; color: red;' class='fas fa-ban'></i>" . "</td>";
   ...
   echo  echo "<td>open:".$row['opening']."<br>close:".$row['closing']."</td>";
  echo "</tr>";
  }	
