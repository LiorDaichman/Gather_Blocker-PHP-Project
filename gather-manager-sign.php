...
<?php
session_start();
echo $_SESSION["MpasswordErr"];
echo $_SESSION["MuserErr"];


?>


<p>hello dear manager,please enter your private details</p>

<form action="manager_action.php"target="_self" method="post" autocomplete="off">
