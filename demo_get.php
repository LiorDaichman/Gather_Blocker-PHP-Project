...
$sql="SELECT `id`, `name`, `address`, `city`, `max-capacity`, `category`, `user-name`,`real-time`, TIME_FORMAT(`opening`, '%h:%i%p') `opening`,TIME_FORMAT(`closing`, '%h:%i%p') `closing` FROM `shops` WHERE  `city`='$q'";
