...
<a href="#"><i class="fas fa-user"></i><? echo $_SESSION['username']."<br>";echo "working at :".$_SESSION["workerBuisness"];  if($_SESSION['insideB']!=" "){
 ...
 <a href="#" ><i  class ="fas fa-store-alt"></i>Store presence update</a>
  <a href="javascript:void(0)" class="closebtn" onclick="closeNav()">&times;</a>
  <a href="before_aprooved.php"><i class='fab fa-drupal'></i> Client-app</a>
...
<h2 style='font-family:Baumans'>untill the manager of shop you enterd will aprrove you , use our client app</h2>

<p align="center" style='font-family:Baumans'>select the buisness you are entering or waiting to enter (on a line outside)<br> and help other people know the number of presents at the buisness </p>

<p align="center" style='font-family:Baumans'>you can select a city in order to watch available buisnesess by cities</p>

<p align="center" style='font-family:Baumans'>you can select a category in order to watch available buisnesess by categories</p><br> 

<p align="center" style='font-family:Baumans'>by pressing the check in button of the current buisness on the Shop-list Table <br> <br> or choosing the buisness from the full buisness list below<br><br> 
you will update your presents at the buisness and help us display the most accurate information <br> <br> please dont forget to check out when you leave as well
