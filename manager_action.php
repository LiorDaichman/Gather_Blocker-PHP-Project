...
if(availableUser($get_user)==false){
	$_SESSION["MuserErr"] = "user name not available";
    
}
if(passwordCheck($get_pas)==false){
	$_SESSION["MpasswordErr"] = "password is too short";
	}
	if(passwordCheck_confirm($get_pas,$get_pas_confirm)==false){
	$_SESSION["MpasswordErr"] = "-password isn't match ";}
	
if($_SESSION["MpasswordErr"] != ""||$_SESSION["MuserErr"] != ""){ header("Location:gather-manager-sign.php");}
else{
...
$sql = "INSERT INTO `managers`(`id`, `first-name`, `last-name`, `user-name`, `password`)VALUES(null,'$get_name','$get_lname','$get_user','$get_pas')";
